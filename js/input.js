...
(function () {
  ...
  var kb = { left: false, right: false, up: false, down: false, action: false, pause: false, ledger: false };
  ...
  function onKeyDown(e) {
    switch (e.code) {
      ...
      case 'KeyB': kb.ledger = true; break;
    }
  }
  ...
  function onKeyUp(e) {
    switch (e.code) {
      ...
      case 'KeyB': kb.ledger = false; break;
    }
  }
